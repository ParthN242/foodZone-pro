      ...
      <section className="lg:px-32 py-6 px-4">
        ...
        <div className="text-gray-600 body-font">
          <div className="container mx-auto lg:-mt-28 flex px-2 py-6 md:flex-row flex-col items-center">
            <div
              className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start justify-center md:text-left items-start text-start"
              data-aos="fade-left"
            >
            ...
            <div
              className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 lg:p-8"
              data-aos="fade-right"
            >
              <img
                className="object-cover object-center rounded w-full h-auto"
                alt="hero"
                src="/Free shipping-pana.png"
                width={800}
                height={600}
              />
            </div>
        ...
        <div className="text-gray-600 body-font mt-6">
          <div className="container mx-auto lg:-mt-28 flex px-2 py-6 md:flex-row-reverse flex-col items-center">
            <div
              className="lg:flex-grow md:w-1/2 lg:pl-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-start text-start"
              data-aos="fade-left"
            >
              <h1 className="sm:text-3xl text-2xl mb-4 font-medium text-gray-900">
            ...
            <div
              className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 sm:p-12"
              data-aos="fade-right"
            >
              <img
                alt="chef"
        ...
        <div className="flex flex-col items-center justify-center container mt-8 mb-12">
          <div
            className="flex items-start w-full px-2 justify-start flex-col"
            data-aos="fade-right"
          >
            <h1 className="sm:text-3xl text-2xl mb-4 font-semibold text-gray-900 capitalize">
              Why choose us
            </h1>
            <p className="mb-8 leading-relaxed font-medium">
              Copper mug try-hard pitchfork pour-over freegan heirloom neutra
          ...
          <div className="grid sm:grid-cols-2 gap-8 p-4">
            <div
              className="flex items-start bg-red-100 p-4 justify-center gap-4 rounded-lg shadow-lg"
              data-aos="zoom-in"
            >
              ...
              <div className="flex flex-col">
                <h4 className="text-neutral-800 font-medium text-lg capitalize">
                  Fastest delivery
                </h4>
                <p>
            ...
            <div
              className="flex items-start bg-yellow-100 p-4 justify-center gap-4 rounded-lg shadow-lg"
              data-aos="zoom-in"
            >
            ...
            <div
              className="flex items-start bg-blue-100 p-4 justify-center gap-4 rounded-lg shadow-lg"
              data-aos="zoom-in"
            >
            ...
            <div
              className="flex items-start bg-green-100 p-4 justify-center gap-4 rounded-lg shadow-lg"
              data-aos="zoom-in"
            >
